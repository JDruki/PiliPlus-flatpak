...
def main() -> None:
    ...
    parser.add_argument("--repo-name", default="piliplus")
    parser.add_argument("--repo-title", default="PiliPlus Flatpak")
    parser.add_argument("--repo-comment", default="Unofficial PiliPlus Flatpak builds")
    parser.add_argument(
        "--repo-description",
        default="Auto-built Flatpak repository for upstream PiliPlus releases.",
    )
    parser.add_argument("--base-url", default="")
    parser.add_argument("--repo-url", default="")
    parser.add_argument("--gpg-key", type=Path)
    parser.add_argument("--icon-path", default="assets/logo.png", type=Path)
...
<body>
  ...
  <p><a href="{ref_link}">Install PiliPlus directly</a></p>
